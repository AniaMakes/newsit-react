...
var _StoryMain = __webpack_require__(/*! ./StoryMain */ "./src/components/StoryMain.js");

var _StoryMain2 = _interopRequireDefault(_StoryMain);
...
var StoryMain = function StoryMain(_ref) {
	var storyData = _ref.storyData;
	var url = storyData.url,
	    urlToImage = storyData.urlToImage,
	    title = storyData.title,
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(
				'p',
				{ className: 'story-main-description' },
				description
			)
		)
	);
...
exports.default = StoryMain;

/***/ }),

/***/ "./src/containers/FeedContainer.js":
/*!*****************************************!*\
  !*** ./src/containers/FeedContainer.js ***!
  \*****************************************/
/*! no static exports found */
...
var _Feed = __webpack_require__(/*! ../components/Feed */ "./src/components/Feed.js");
...
exports.default = (0, _reactRedux.connect)()(_Search2.default);
...
var store = (0, _redux.createStore)(_reducers2.default, (0, _redux.applyMiddleware)(thunkMiddleware));
